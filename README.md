...
This project contains a Discord app aimed to assist with Leetcode logistics. It is based on [Discord's getting started guide](https://discord.com/developers/docs/getting-started).
